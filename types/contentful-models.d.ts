 ...
 *
 * Generated at: 2026-03-04T01:12:06.739Z
...
export type TBlockWrapperEntrySkeleton = EntrySkeletonType<TBlockWrapperFields, 'blockWrapper'>

export type TBlockWrapperEntry<L extends string = 'pt-PT'> = Entry<
  TBlockWrapperEntrySkeleton,
  undefined,
  L
>
...
export type THeroEntrySkeleton = EntrySkeletonType<THeroFields, 'hero'>

export type THeroEntry<L extends string = 'pt-PT'> = Entry<THeroEntrySkeleton, undefined, L>
...
export type TFaqsEntrySkeleton = EntrySkeletonType<TFaqsFields, 'faqs'>

export type TFaqsEntry<L extends string = 'pt-PT'> = Entry<TFaqsEntrySkeleton, undefined, L>
